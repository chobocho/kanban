...
| 📅 **달력 보기** | 모든 보드의 시작일🚩·마감일⏰ 카드를 달력 하나에 모아 보기 (**월간·주간 전환**, 시작일~마감일은 이어진 **기간 바**로 표시, 지남🔴·완료✅ 구분, 일정 클릭 시 해당 보드로 전환 후 카드 상세 열기, **날짜 클릭으로 그 날짜가 마감일인 새 카드 생성**) |
